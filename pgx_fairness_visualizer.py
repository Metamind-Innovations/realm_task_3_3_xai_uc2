...
def create_consolidated_visualization(data, demographic_key, output_dir, ethnicity_mapping=None):
    ...
    if fpr_data:
        ...
        if matrix_data:
            ...
            fig.text(0.25, 0.495, 'Shows average false positive rates across phenotypes; lower is better',
    ...
    if prediction_data:
        ...
        if matrix_data:
            ...
            fig.text(0.75, 0.495, 'Shows average prediction rates across phenotypes; closer to 0.5 is better',
                     ha='center', fontsize=10, style='italic', color='#555555')
        else:
    ...
    if prediction_data:
        ...
        if pred_disparity:
            ...
            fig.text(0.25, 0.025, 'Shows maximum difference in prediction rates between groups; lower is better',
                     ha='center', fontsize=10, style='italic', color='#555555')
        else:
    ...
    if fpr_data:
        ...
        if fpr_disparity:
            ...
            fig.text(0.75, 0.025, 'Shows maximum difference in false positive rates between groups; lower is better',
                     ha='center', fontsize=10, style='italic', color='#555555')
        else:
